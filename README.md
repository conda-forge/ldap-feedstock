...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/ldap-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/ldap-feedstock)
...
Once the `conda-forge` channel has been enabled, `ldap` can be installed with:

```
conda install ldap
```

It is possible to list all of the versions of `ldap` available on your platform with:
